...
{
  comm_state[0].state = {false, true, true, true, true};
  comm_state[1].state = {true, false, true, true, true};
  comm_state[2].state = {true, true, false, true, true};
  comm_state[3].state = {true, true, true, false, true};
  comm_state[4].state = {true, true, true, true, false};
